...
describe('Array#read', function() {
  ...
  it('decodes correctly', function() {
    ...
    expect(read(many, [0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x01])).to.eql([0,1]);
    expect(read(many, [0x00,0x00,0x00,0x01,0x00,0x00,0x00,0x01])).to.eql([1,1]);
  });
...
describe('Array#write', function() {
  ...
  it('encodes correctly', function() {
    expect(write([1,2])).to.eql([0x00,0x00,0x00,0x01,0x00,0x00,0x00,0x02]);
    expect(write([3,4])).to.eql([0x00,0x00,0x00,0x03,0x00,0x00,0x00,0x04]);
  });
