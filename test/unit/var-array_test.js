...
describe('VarArray#read', function() {
  ...
  it('decodes correctly', function() {
    ...
    expect(read([0x00,0x00,0x00,0x02,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x01])).to.eql([0,1]);
    expect(read([0x00,0x00,0x00,0x02,0x00,0x00,0x00,0x01,0x00,0x00,0x00,0x01])).to.eql([1,1]);
  });
...
describe('VarArray#write', function() {
  it('encodes correctly', function() {
    ...
    expect(write([0,1])).to.eql([0x00,0x00,0x00,0x02,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x01]);
  });
